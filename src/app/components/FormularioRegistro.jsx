...
const handleSubmit = async (e) => {
    ...
    form.set("nombre", formUsuario.nombre)
    form.set("apellido", formUsuario.apellido)
    form.set("email", formUsuario.email)
    form.set("password", formUsuario.password)
    form.set("repeatPassword", formUsuario.repeatPassword)
    ...
    return (
        <div className="flex justify-center items-center h-[45rem] mb-10 ">
            <form className=" text-xl rounded-xl flex-col flex  p-4 justify-center  bg-transparent w-96 h-96" onSubmit={handleSubmit}>
                ...
                <div className="w-80">
                    <label className="dark:text-white" htmlFor="apellido">
                        Apellido
                    </label>
                    <input
                        className="rounded-md w-full border-solid border-4 border-indigo-600 mb-4"
                ...
                <div className="flex justify-center items-center">
                    <div className="w-80">
                        <label className="dark:text-white" htmlFor="repeatPassword">
                ...
                <span className="text-sm text-slate-400 text-center w-80 pt-4">¿Ya tienes una cuenta? <Link href="/auth/login"><b>Inicia Sesión acá</b></Link></span>
            </form>
        </div>
    );
}
